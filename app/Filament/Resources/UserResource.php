...
class UserResource extends Resource {
    ...
    public static function form(Form $form): Form {
        return $form->schema([
            ...
            Forms\Components\Select::make('currency')->label('Currency')->options(config('currencies.allowed'))->default(config('currencies.default'))->required(),
            Forms\Components\TextInput::make('main_balance')->numeric()->step(0.01)->suffix(fn ($get) => $get('currency') ?: config('currencies.default'))->required(),
